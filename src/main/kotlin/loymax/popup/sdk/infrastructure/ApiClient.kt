package loymax.popup.sdk.infrastructure
...
class ApiClient(
    ...
    companion object {
        @JvmStatic
        protected val baseUrlKey = "loymax.popup.sdk.baseUrl"

        @JvmStatic
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty(baseUrlKey, "https://api.loymaxsc.net")
        }
    }
}
